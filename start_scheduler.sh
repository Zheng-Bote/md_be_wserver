...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -ldflags="-s -w -X main.version=${MITM_SERVER_VERSION}" -o ./bin/md_be_wserver ./cmd/md_be
...
export MD_BE_MASTER_KEY="6mkdHpNHfF5bdCMj/+MeYAM4wVMy3nJ9FRxpSibhumE="
export MD_BE_WSERVER_PASSWORD="Sidolin1"
./bin/md_be_wserver
